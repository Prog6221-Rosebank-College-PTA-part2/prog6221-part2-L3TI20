...
namespace CyberSecurityAwarenessBot.Responses
{
    ...
    public class ResponseEngine
    {
        ...
        // This is where all the response content lives each topic has keywords to trigger it, multiple possible responses, and a follow-up message for deeper dives.
        ...
        private static List<Topic> Build() => new()
        {
            ...
            {
                Name = "phishing",
                Keywords = new[] { "phishing","scam","fake email"},
                Responses = new[]
                {
            ...
            {
                Name = "VPN",
                Keywords = new[] { "vpn","public wifi","public wi-fi","free wifi","open network" },
                Responses = new[]
                {
            ...
            {
                Name = "encryption",
                Keywords = new[] { "encryption","encrypt","encrypted","decrypt" },
                Responses = new[]
                {
